...
let filterButtonsDOM = document.querySelector("#filterButtons")

let filterButtonsListDOM = document.querySelector("#filterButtonsList")
filterButtonsListDOM.classList.add("list-unstyled")

let filterButtonsArray = ["All", "Korea", "Japan", "China"]

for(let i=0; i<4; i++){
  let filterButtonsListLiDOM = document.createElement("li")
  filterButtonsListLiDOM.classList.add("list-inline-item", "border", "border-1", "rounded", "p-2", "border-dark")

  let filterButtonsListLink = document.createElement("a")
  filterButtonsListLink.href = "#"
  filterButtonsListLink.classList.add("text-dark", "text-decoration-none")
  filterButtonsListLink.innerHTML = filterButtonsArray[i]
